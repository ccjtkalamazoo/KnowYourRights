...
export const R = {
  ...
  demo: {
    eyebrow: "START HERE",
    title: "PLAY THE DEMO",
    blurb: "Quick questions about your rights, fifteen a round, shuffled every time. The rest of the map is still being written.",
    playLabel: "Play now",
    ...
    outOfRunsBest: (n) => `Your best score was ${n} out of 15.`,
